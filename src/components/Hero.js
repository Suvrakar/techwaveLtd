                    ...
                    <div id='hero' className="flex flex-col lg:flex-row py-8 justify-between text-center lg:text-left">
                        <div className="lg:w-1/2 flex flex-col justify-center" data-aos="zoom-in" data-aos-delay="200">
                            <h1 className="mb-5 md:text-5xl text-3xl font-bold text-blue-900">
                                ...
                                Techwave Solutions : Innovating the Future with Web, App, AI & Cloud Solutions – Your Trusted Partner in Digital Excellence
                            </h1>
                            <div className="text-xl font-semibold tracking-tight mb-5 text-gray-500">Empowering businesses with cutting-edge development, cloud solutions, managed services, and staff augmentation.</div>
                            <div className="mb-4 space-x-0 md:space-x-2 md:mb-8">
                                ...
                                <a
                                    href="https://www.upwork.com/freelancers/~0165f080e7d8e7c417"
                                    target="_blank"
